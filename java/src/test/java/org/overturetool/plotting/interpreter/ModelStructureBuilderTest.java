...
public class ModelStructureBuilderTest {
    ...
    @Test
    public void testBuildWithNoRootClassReturnsEmptyModelStructure() throws Exception {
        final RemoteControl remote = new RemoteControl()
        {
            public void run(RemoteInterpreter interpreter) throws Exception
            {
    ...
    @Test
    public void testBuildWithRootClassReturnsCorrectModelStructure() throws Exception {
    ...
    @Test
    public void testBuildWithRootClassReturnsCorrectModelStructureSeveralLayers() throws Exception {
        ModelStructure expected = new ModelStructure();
